let student_form = document.getElementById('updateorg-validation');
...
student_form.addEventListener('submit', async (e) => {
    ...
    if (student_form.checkValidity() === true) {
        ...
        let response = await fetch('http://localhost:8080/project3-1.0-SNAPSHOT/api/organization/update', {
            method: 'POST',
            headers: {
